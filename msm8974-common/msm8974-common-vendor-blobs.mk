...
PRODUCT_COPY_FILES += \
    ...
    vendor/oppo/msm8974-common/proprietary/bin/dpmd:system/bin/dpmd \
    ...
    vendor/oppo/msm8974-common/proprietary/etc/dpm/dpm.conf:system/etc/dpm/dpm.conf \
    vendor/oppo/msm8974-common/proprietary/etc/dpm/nsrm/NsrmConfiguration.xml:system/etc/dpm/nsrm/NsrmConfiguration.xml \
    vendor/oppo/msm8974-common/proprietary/etc/permissions/cneapiclient.xml:system/etc/permissions/cneapiclient.xml \
    vendor/oppo/msm8974-common/proprietary/etc/permissions/com.qti.dpmframework.xml:system/etc/permissions/com.qti.dpmframework.xml \
    vendor/oppo/msm8974-common/proprietary/etc/permissions/com.quicinc.cne.xml:system/etc/permissions/com.quicinc.cne.xml \
    vendor/oppo/msm8974-common/proprietary/etc/permissions/ConnectivityExt.xml:system/etc/permissions/ConnectivityExt.xml \
    vendor/oppo/msm8974-common/proprietary/etc/permissions/dpmapi.xml:system/etc/permissions/dpmapi.xml \
    vendor/oppo/msm8974-common/proprietary/framework/cneapiclient.jar:system/framework/cneapiclient.jar \
    vendor/oppo/msm8974-common/proprietary/framework/com.qti.dpmframework.jar:system/framework/com.qti.dpmframework.jar \
    vendor/oppo/msm8974-common/proprietary/framework/com.quicinc.cne.jar:system/framework/com.quicinc.cne.jar \
    vendor/oppo/msm8974-common/proprietary/framework/ConnectivityExt.jar:system/framework/ConnectivityExt.jar \
    vendor/oppo/msm8974-common/proprietary/framework/dpmapi.jar:system/framework/dpmapi.jar \
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libcne.so:system/vendor/lib/libcne.so \
    ...
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libdpmframework.so:system/vendor/lib/libdpmframework.so \
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libdpmnsrm.so:system/vendor/lib/libdpmnsrm.so \
    ...
    vendor/oppo/msm8974-common/proprietary/etc/permissions/com.qti.location.sdk.xml:system/etc/permissions/com.qti.location.sdk.xml \
    ...
    vendor/oppo/msm8974-common/proprietary/framework/com.qti.location.sdk.jar:system/framework/com.qti.location.sdk.jar \
    ...
    vendor/oppo/msm8974-common/proprietary/vendor/bin/slim_daemon:system/vendor/bin/slim_daemon \
    ...
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libdataitems.so:system/vendor/lib/libdataitems.so \
    ...
    vendor/oppo/msm8974-common/proprietary/vendor/lib/liblocationservice_glue.so:system/vendor/lib/liblocationservice_glue.so \
    vendor/oppo/msm8974-common/proprietary/vendor/lib/liblowi_client.so:system/vendor/lib/liblowi_client.so \
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libslimclient.so:system/vendor/lib/libslimclient.so \
    ...
    vendor/oppo/msm8974-common/proprietary/vendor/lib/libQtiTether.so:system/vendor/lib/libQtiTether.so \
